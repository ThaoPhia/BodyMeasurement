    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="<?php echo base_url(); ?>">&nbsp;&nbsp;Body Measurements</a>
          <div style="height: 0px;" class="nav-collapse collapse">
            <ul class="nav">
              <li class="active"><a href="<?php echo base_url(); ?>">Home</a></li>
			  <li><a href="<?php echo base_url('measurement/example_1'); ?>">Example 1</a></li>
                          <li><a href="<?php echo base_url('measurement/example_2'); ?>">Example 2</a></li>
              <li><a href="<?php echo base_url('measurement/example_3'); ?>">Example 3</a></li>
              <li><a href="<?php echo base_url('measurement/example_4'); ?>">Example 4</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
